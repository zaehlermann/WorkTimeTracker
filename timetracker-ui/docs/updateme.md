...
```bash
scp target/timetracker-ui-1.5.0.jar mike@timetracker.local:/home/mike/timetracker
or
scp target/timetracker-ui-1.5.0.jar mike@192.168.188.83:/home/mike/timetracker
```
...
mv timetracker-ui.jar timetracker-ui-1.4.0-backup.jar
mv timetracker-ui-1.5.0.jar timetracker-ui.jar
