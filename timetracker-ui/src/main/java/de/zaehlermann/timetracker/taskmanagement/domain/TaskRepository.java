package de.zaehlermann.timetracker.taskmanagement.domain;
...
public interface TaskRepository extends JpaRepository<Task, Long>, JpaSpecificationExecutor<Task>, Serializable {
